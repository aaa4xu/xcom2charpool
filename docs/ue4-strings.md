...
The least worst method to do this for all languages seems to be mentioned here [http://en.wikipedia.org/wiki/ISO/IEC_8859](http://en.wikipedia.org/wiki/ISO/IEC_8859)
...
The mappings from [https://dev.epicgames.com/documentation/404](https://dev.epicgames.com/documentation/404) contain the conversion rules for the above mentioned languages. 'CAPITAL LETTER' and 'SMALL LETTER' info would be cross referenced with the appropriate unicode character to get the desired result.
